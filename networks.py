...
def get_vgg16(pretrained=False, out_features=None):
...
def get_resnet18(pretrained=False, out_features=None):
...
def get_densenet121(pretrained=False, out_features=None):
